...
[Home](./index.md) &gt; [@sigmamessaging/otp-sdk](./otp-sdk.md) &gt; [SigmaOtpSDK](./otp-sdk.sigmaotpsdk.md) &gt; [onResendChannel](./otp-sdk.sigmaotpsdk.onresendchannel.md)

## SigmaOtpSDK.onResendChannel() method
...
```typescript
onResendChannel(requestId: string, handler: (...args: SigmaOtpSDKGlobalEvents[SigmaOtpSDKGlobalEventNames.RESEND_CHANNEL]) => void): {
...
(...args: [SigmaOtpSDKGlobalEvents](./otp-sdk.sigmaotpsdkglobalevents.md)<!-- -->\[[SigmaOtpSDKGlobalEventNames.RESEND\_CHANNEL](./otp-sdk.sigmaotpsdkglobaleventnames.md)<!-- -->\]) =&gt; void
