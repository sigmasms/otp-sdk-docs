...
[Home](./index.md) &gt; [@sigmamessaging/otp-sdk](./otp-sdk.md) &gt; [SigmaOtpSDK](./otp-sdk.sigmaotpsdk.md) &gt; [onChannelChanged](./otp-sdk.sigmaotpsdk.onchannelchanged.md)

## SigmaOtpSDK.onChannelChanged() method
...
```typescript
onChannelChanged(requestId: string, handler: (...args: SigmaOtpSDKGlobalEvents[SigmaOtpSDKGlobalEventNames.CHANNEL_CHANGED]) => void): {
...
(...args: [SigmaOtpSDKGlobalEvents](./otp-sdk.sigmaotpsdkglobalevents.md)<!-- -->\[[SigmaOtpSDKGlobalEventNames.CHANNEL\_CHANGED](./otp-sdk.sigmaotpsdkglobaleventnames.md)<!-- -->\]) =&gt; void
